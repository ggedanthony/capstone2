...
<div class="container">
	...
	<div class="d-flex col-md-10" id="menu">
		<div class="col-md-4 p-0 align-center justify-content-center align-items-center d-flex"><a href="/storage">{{count($storages)}} Total Asset</a></div>
		...
		<div class="col-md-3 p-0 align-center justify-content-center align-items-center d-flex" id="total_used"><a href="/request/approved">
				@if(Auth::user()->role_id == 1)
				...
				@endif
			Total on Used</a></div>
		<div class="col-md-4 p-0 align-center justify-content-center align-items-center d-flex"><a href="/request/hold">
				@if(Auth::user()->role_id == 1)
	...
	<div class="row" id="main">
		<table class="table">
			...
			<tbody>
				@if(Auth::user()->role_id == 1)
				@foreach($orders->where('status_id', 4) as $order)
				<tr>
			...
			@else
			@foreach($orders->where('status_id', 4)->whereIn('user_id', Auth::user()->id) as $order)
				<tr>
					<th>{{ucfirst($order->name)}}</th>
					<td>{{$order->quantity}}</td>
					<td>{{$order->created_at->diffForHumans()}}</td>
